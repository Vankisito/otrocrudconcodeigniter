...
<body>
    <form method="post" action="<?php echo base_url('welcome/guardar');?>">
        <div class="mb-3">
        ...
        <input type="text" name="placa" id="floatingInput2" class="form-control" placeholder="Placa...">
        </div >
        <div class="mb-3">
        ...
        <input type="number" name="modelo" id="floatingInput4" class="form-control" placeholder="Modelo...">
        </div>
        <div class="div_btn">
